    ...
    public class WeatherInTheCityDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<City>().HasData(new List<City>() {
                ...
                new City() { Id = id++, CityName = "Warsaw", CountryName = "Poland", CountryCode = "pl" },
                new City() { Id = id++, CityName = "Gdansk", CountryName = "Poland", CountryCode = "pl" },
                new City() { Id = id++, CityName = "Cracow", CountryName = "Poland", CountryCode = "pl" },
                new City() { Id = id++, CityName = "Wroclaw", CountryName = "Poland", CountryCode = "pl" },
